...
```{r message=FALSE, warning=FALSE}
grizzly <- read.csv("~/Desktop/BIS15L_W26_jrkwok/lab14/data/bear-sightings.csv")
```
...
```{r}
map2 <- get_stadiamap(bbox2, maptype = "stamen_terrain", zoom = 5)
```
...
```{r}
ggmap(map2)+
  geom_point(data = grizzly, aes(longitude, latitude), size= .75, color= "red")
```
