...
```{r}
filter(penguins, body_mass_g %in% c(5250, 5500)) #look into body mass, ONLY pull 5250 and 5500
```
...
1. Load the data
```{r}
fish_data<- read.csv("~/Desktop/BIS15L_W26_jrkwok/lab5/data/Gaeta_etal_CLC_data.csv")
names(fish_data)
```
