...
```{r}
mammals <-read_csv("~/Desktop/BIS15L_W26_jrkwok/lab6/data/mammal_lifehistories_v2.csv") %>% 
  clean_names()
```
...
```{r}
mammals %>% 
  mutate(across(everything(), tolower)) #be careful w numeric variables
```
