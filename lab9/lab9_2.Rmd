...
```{r}
gene_exp <- read_csv("~/Desktop/BIS15L_W26_jrkwok/lab9/data/gene_exp.csv")
gene_exp
```
...
```{r}
beachbug <- read_csv("~/Desktop/BIS15L_W26_jrkwok/lab9/data/beachbugs_long.csv")
beachbug
```

2. Use `pivot_wider` to transform the data into wide format.
```{r}
beachbug_wide <-beachbug %>% 
