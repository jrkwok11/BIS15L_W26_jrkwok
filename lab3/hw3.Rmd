...
```{r}
mountain_name <- c("everest", "k2", "kangchenjunga", "lhotse", "makalu")
height_feet <- c(29032,28251, 28169, 27940, 27766)
...
```{r}
summits <- c(12884, 800, 500, 933, 500)
